...
const KanbanChart = () => {
    const [boards, setBoards] = useState([
        {id: 1, title:'В РАБОТУ', items: [{id: 1, name: 'пойти', project:"проект", team:"команда", user:"Власов Игорь Александрвич", deadline:'2023-07-24'}, {id: 6, name: 'а теперь знаю'}, {id: 7, name: 'не знаю'}]},
